...
NoteWave is a modern iOS voice note application that enables users to record, merge, transcribe, and interact with audio notes using AI.  
Built using Swift + MVVM architecture, it focuses on reliability, clean design, and intelligent audio processing.
...
- Ensures performance and storage optimization
